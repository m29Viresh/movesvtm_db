...
BOT_TOKEN = environ.get('BOT_TOKEN', '8383833294:AAEdCjXSjtij_nXKkv9XT90t6vjQEvZHunQ')
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7643842600').split()]
USERNAME = environ.get('USERNAME', "t.me/vtm_channal_admin") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003771968468'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+OwUjQev74-A4NTRl')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003804461955').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://movesvtm_db:8792234103@123@movesvtm.zfyuchu.mongodb.net/?appName=movesvtm")
DATABASE_NAME = environ.get('DATABASE_NAME', "movesvtm_db")
